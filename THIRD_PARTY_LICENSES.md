...
## Archify diagram viewer (added 2026-09-26)

`assets/diagrams/maida-workflow.html` is generated by Archify v2.17
(<https://github.com/tt-a1i/archify>, MIT License, Copyright (c) 2026 tt-a1i).
The file embeds the Archify viewer runtime and a JetBrains Mono subset (SIL OFL
1.1). It makes no network requests. Regenerate it from
